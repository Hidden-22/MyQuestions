...
// }
$str="update message set m_new_entry_status=1";
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li> <a class="waves-effect waves-dark" href="feedback.php" aria-expanded="false"><i class="mdi mdi-help-circle"></i><span class="hide-menu">Feed Back</span></a>
                               ...
                               <li> <a class="waves-effect waves-dark active" href="message.php" aria-expanded="false" ><i class="fas fa-envelope"></i><span class="hide-menu">Message</span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-hover" >
                                        ...
                                        <tbody id="active-block">
                                            <?php while($massageRow=mysqli_fetch_assoc($res))
                                            {
                                            echo"<tr>";
